...
public class AssignmentModel implements Parcelable {
    ...
    public static List<AssignmentModel> getAssignments(){
        ...
        assignmentModels.add(new AssignmentModel("JAN 1, 2019","FEB 4, 2022","MR. AYODELE", R.drawable.vtwo,"DIFFUSION","Calculate the radius of a circle given the radius as 7cm, 4cmCalculate the radius of a circle given the radius as 7cm, 4cm\nCalculate the radius of a circle given the radius as 7cm, 4cm\n\nCalculate the radius of a circle given the radius as 7cm, 4cm\nCalculate the radius of a circle given the radius as 7cm, 4cm\n"));
